...
namespace LandsDepartment.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            RegistrationViewModel objRegistration = new RegistrationViewModel();
            objRegistration.loginmodel = new LoginModel();
            objRegistration.registermodel = new RegisterModel();
       ...
       // [ValidateAntiForgeryToken]
        public ActionResult Login(RegistrationViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {

                MembershipUser user = Membership.GetUser(model.loginmodel.UserName);
        ...
        [HttpPost]
       // [ValidateAntiForgeryToken]
        public ActionResult LoginMain(string emailaddress, string userPassword)
        {
            if (ModelState.IsValid)
            {

                MembershipUser user = Membership.GetUser(emailaddress);
                if (Membership.ValidateUser(emailaddress, userPassword))
                {
        ...
        public ActionResult Register(RegistrationViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                   ...
                   // Guid g = new Guid("02CF547F-514A-43C5-8D55-2D80734C320E");
                   ...
                   // return RedirectToAction("Index", "Home");
                    FormsAuthentication.SetAuthCookie(model.registermodel.UserName, false);
                    return RedirectToAction("Index", "Home");
                }
